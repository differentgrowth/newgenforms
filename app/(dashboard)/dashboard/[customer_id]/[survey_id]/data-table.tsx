  ...
  return (
    <div className="flex flex-col space-y-6">
      <div className="flex flex-col space-y-3">
        <div className="grow flex flex-row flex-wrap justify-start items-end gap-1.5">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                className="capitalize min-w-[150px] justify-center"
              >
                <MixerVerticalIcon className="mr-2 h-4 w-4 shrink-0" />
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                ...
                className="capitalize min-w-[150px] justify-center"
              >
                <MixerHorizontalIcon className="mr-2 h-4 w-4 shrink-0" />
                View
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent
