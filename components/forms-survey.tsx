    ...
    <>
      ...
      { !!state?.error
        ? (
          <Card
            className={ cn(
              'mt-4 w-full max-w-lg lg:max-w-none mx-auto',
              'border-destructive bg-destructive/10'
            ) }
          >
            <CardContent className="pt-6">
...
export const SurveyQuestionForm = ( { defaultValue, lastOrderValue, customerId, surveyId, handleNewQuestion }: {
  ...
  return (
    <article className="w-full self-stretch flex flex-col relative">
      { !handleNewQuestion
        ? (
          <RemoveQuestionForm
      ...
      >
        ...
        >
          ...
          <CardContent
            className={ cn(
              "grow mt-3 grid grid-cols-1 content-start gap-4",
              "sm:grid-cols-2"
            ) }
          >
            <input
            ...
            { question.type === QUESTION_TYPE.EMAIL || question.type === QUESTION_TYPE.PHONE
              ? (
                <div className="md:col-span-2 h-9 px-3 py-1 flex items-center gap-1.5 border rounded">
                  <Switch
      ...
      { isDirty
        ? (
          <Card
            className={ cn(
              'mt-4 w-full max-w-xl mx-auto bg-muted'
            ) }
          >
            <CardContent className="pt-6">
              <CardDescription>
    ...
    <>
      ...
      >
        { newQuestion
          ...
          : 'Add question' }
        { newQuestion
          ? <TrashIcon className="ml-1.5 w-4 h-4" />
          : <PlusCircledIcon className="ml-1.5 w-4 h-4" />
        }
      </Button>
      { newQuestion
        ? (
